...
var providers = []Provider{
	...
	},
	{
		...
		DoT: []TLS{{"74.82.42.42", "ordns.he.net"}},
		DoH: []HTTPS{{"https://ordns.he.net/dns-query"}},
	},
	{
		ID: "ffmuc", Name: "Freifunk München", Note: "без логов, Германия",
		DoT: []TLS{{"5.1.66.255", "dot.ffmuc.net"}, {"185.150.99.255", "dot.ffmuc.net"}},
...
var candidates = []Provider{
	...
	{ID: "blahdns-de", Name: "BlahDNS DE", Note: "без логов, режет рекламу, Германия (DoT)",
		DoT: []TLS{{"78.46.244.143", "dot-de.blahdns.com"}}},
